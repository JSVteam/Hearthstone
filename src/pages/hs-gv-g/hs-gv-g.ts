...
import { CartaGvG } from '../../carta';
import { DataProvider } from '../../providers/data/data';
import { LoadingController } from 'ionic-angular/components/loading/loading-controller';

/**
 * Generated class for the HsGvGPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-hs-gv-g',
  templateUrl: 'hs-gv-g.html',
})
export class HsGvGPage {
  items = [];
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad HsGvGPage');
  }
